...
class TestRandomRouter:
    def setup(self):
        ...
        self.graph.add_nodes_from(["h1", "h2", "s1", "s2"])
        self.graph.add_edge("h1", "s1", weight=1)
        self.graph.add_edge("s2", "h2", weight=2)
        self.graph.add_edge("h1", "s2", weight=2)
        self.graph.add_edge("s1", "h2", weight=1)
        self.graph.add_edge("h1", "h2", weight=4)
